...
<html lang="en">
  <head>
    <title>Compra &mdash; Contacto</title>
    <meta charset="utf-8">
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="./admin/dashboard/plugins/summernote/summernote-bs4.min.css">
        ...
        <div class="row">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Reclamo<span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">Codigo del pedido </label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_message" class="text-black">Asunto</label>
          ...
          <div class="col-md-5 ml-auto">
            <div class="p-4 border mb-3">
              <span class="d-block text-primary h6 text-uppercase">Managua</span>
              <p class="mb-0">Luis alfonso </p>
            </div>
            <p> Para hacer un reclamo, soporte o ver el proceso de las devolcuiones como funciona y como empezar ese proceso
                puede leer nuestras politicas o bien contactarse con nostros llenando el formulario a su izquierda
                dejandonos saber su asunto 
            </p>
            <button onclick="window.location='MOGJI Virtual Shop - Politicas de devoluciones y Garantia (1).pdf'">Leer mas de las politicas</button>
            <br>
            <br>
            <br>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-infos clearfix">
                      <span class="direct-chat-name float-left">MOGJI</span>
                      <span class="direct-chat-timestamp float-right">23 Jan 2:00 pm</span>
                    </div>
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="./admin/dashboard/dist/img/user1-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                  ...
                  <div class="direct-chat-msg right">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="./admin/dashboard/dist/img/user3-128x128.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="./admin/dashboard/dist/img/user1-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="./admin/dashboard/dist/img/user7-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="./admin/dashboard/dist/img/user3-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="./admin/dashboard/dist/img/user5-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="./admin/dashboard/dist/img/user6-128x128.jpg" alt="User Avatar">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="./admin/dashboard/dist/img/user8-128x128.jpg" alt="User Avatar">

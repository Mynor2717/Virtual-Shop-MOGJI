  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Verifique</h2>
          </div>
          <div class="col-md-7">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <div class="col-md-12">
                      <label for="c_fname" class="text-black">Cliente veterano <?php echo $arregloUsuario['nombre']; ?></label>
                    </div>
                    </div>
                </div>
                <div class="form-group row">
          ...
          ?>
            <div class="p-4 border mb-3">
              ...
              <span class="d-block text-primary h6 text-uppercase">Total:<?php echo $f['subtotal'];?></span>
            </div>
            <?php } ?>
            <h4>Total: <?php echo $datosUsuario[2];?></h4>
            <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='thankyou.php'">Terminar proceso</button>
          </div>
        </div>
